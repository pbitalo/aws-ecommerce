...
import { CarrierType, OrderProductResponse, OrderRequest, OrderResponse, PaymentType, ShippingType } from "/opt/nodejs/ordersApiLayer" // talvez esteja errado
...
function buildOrder(orderRequest: OrderRequest, products: Product[]) {
    const orderProducts: OrderProductResponse[] = []
    let totalPrice = 0
